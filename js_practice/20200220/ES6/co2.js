...
function toPromise(obj) {
    ...
    if (isGeneratorFunction(obj) || isGenerator(obj)) return co2.call(this, obj);    // 如果obj是个generator函数的话,则递归下去
...
function thunkToPromise(fn) {
    ...
    return new MyPromise(function (resolve, reject) {    // 返回一个promise
...
function objectToPromise(obj){
    ...
    return MyPromise.all(promises).then(function () {    // 还是使用Promise.all并行执行
        return results;
    });
...
function isObject(val) {
    return Object.prototype.toString.call(box).slice(8, -1) === "Object";
};